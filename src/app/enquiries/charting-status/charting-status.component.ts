...
export class ChartingStatusComponent implements OnInit {
  ...
  fetchedAccomodationAvailability: any = [
    ...
    {stn_Code: 'CNB', stn_Name: 'New Delhi', arrival_Time: '00:40', departure_Time: '00:55', distance: '440', chart: 'NOT PREPARED', day: '2' },
    {stn_Code: 'ALD', stn_Name: 'New Delhi', arrival_Time: '03:20', departure_Time: '03:45', distance: '634', chart: 'NOT PREPARED', day: '2' },
    // {stn_Code: 'MUV', stn_Name: 'New Delhi', arrival_Time: '07:55', departure_Time: 'Destination', distance: '755', chart: 'NOT PREPARED', day: '2' }
  ];
